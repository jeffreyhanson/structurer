...
#' @slot S \code{logical} if \code{TRUE} the \eqn{G} matrix similarity statistic used used. Else the \eqn{G \prime} statistic is used. Defaults to \code{FALSE}.
...
#' @param S \code{logical} if \code{TRUE} the \eqn{G} matrix similarity statistic used used. Else the \eqn{G \prime} statistic is used. Defaults to code{FALSE}.
